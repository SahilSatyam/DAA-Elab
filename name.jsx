...
export default function AppLevelRetnRem() {
    ...
    const exportToExcel = (csvData) => {
        ...
        'Info Owner SID', 'Info Owner Name', 'Data Owner SID', 'Data Owner Name', 'Hosting Platform', 'Legal Hold Status', 'Retention Status', 'Destruction Status', 'OBR v/s Non-OBR', 'Has OBR', 'Approved Extended Retention',
    ...
    const exportToPDF = (pdfData) => {
        ...
        'Hosting Platform', 'Legal Hold Status', 'Retention Status', 'Destruction Status', 'OBR v/s Non-OBR', 'Has OBR', 'Approved Extended Retention',
        ...
        row=> [row.LOB_FCTN_NM, row.PROD_NM, row.APPL_SYS_ID, row.APPL_SYS_NM, row.APPL_SYS_STS_NM, row.APPL_OWNR_SID,
            row.INFO_OWNR_SID, row.DATA_OWNR_SID, row.HOST_ENV_NM, row.LGL_HLD_STS, row.DATA_RQR_DOC_STS_CD,
                ...
                <div className="app-level-retn-rem-dashboard-filters">
                    <div className="multiselect">
                        <div className="multiselect-values">
                            <MdsMultiselect
                                data-testid='app-level-retn-rem-app-id-multiselect'
                                name='app-id-multiselect'
                                variant="line"
                                ...
                                {mdsMultiSelectComponentForAppID.map((multiSelect, index) => (
                                    <MdsMultiselectOption
                                        data-testid='app-level-retn-rem-app-id-multiselect-option'
                                        key={index}
                                        id='app-level-retn-rem-app-id-multiselect-option'
                                        state= "hovered"
                    ...
                    <div className="multiselect">
                        <div className="multiselect-values">
                            <MdsMultiselect
                                data-testid='app-level-retn-rem-obr-multiselect'
                                name='obr-multiselect'
                                variant="line"
                                ...
                                {mdsMultiSelectComponentForType.map((multiSelect, index) => (
                                    <MdsMultiselectOption
                                        data-testid='app-level-retn-rem-obr-multiselect-option'
                                        key={index}
                                        id='app-level-retn-rem-obr-multiselect-option'
                                        label={multiSelect.label}
                                        value={multiSelect.value}
                                    ></MdsMultiselectOption>
                                ))}
                    ...
                    <div className="app-level-retn-rem-legal-hold-filter">
                        <MdsSwitch
                            data-testid="app-level-retn-rem-legal-hold-filter"
                    ...
                    <div className="app-level-retn-rem-approved-extended-retn-filter">
                        <MdsSwitch
                            data-testid="app-level-retn-rem-approved-extended-retn-filter"
                    ...
                    <div className="app-level-retn-rem-class_code_comp-filter">
                        <MdsSwitch
                            data-testid="app-level-retn-rem-class_code_comp-filter"
                    ...
                    <div className="app-level-retn-rem-export-options">
                        <MdsButton
                            data-testid="app-level-retn-rem-excel-export-data-button"
                            text="Excel"
                            variant="secondary"
                            widthType="content"
                            type="button"
            ...
            <div className="app-level-retn-rem-datatable">
                <center>
                    <MdsDataTableForAccounts
                        data-testid="app-level-retn-rem-mds-datatable"
                        ...
                        rowData={ appLevelRetnRemFilteredData.map(row => (
                            // appLevelRetnRemFilteredData.slice((currentPage - 1) * pageSize, currentPage * pageSize).map(row => (
                                    [
                                        ...
                                        {value: row["HOST_ENV_NM"] ? String(row["HOST_ENV_NM"]) : "-"},
